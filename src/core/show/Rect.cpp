 ...
 */
std::string Rect::toShortString()
{
    return toShortString(new std::stringstream());
}
 ...
 */
std::string Rect::flattenToString()
{
 ...
 */
//Rect Rect::unflattenFromString(std::string str)
//{
 ...
 * @hide
 */
//void Rect::printShortString(PrintWriter pw)
//{
//    pw.print('[');
//    pw.print(left);
//    pw.print(',');
 ...
 */
void Rect::offsetTo(int newLeft, int newTop)
{
    right += newLeft - left;
    bottom += newTop - top;
    left = newLeft;
 ...
 */
bool Rect::contains(int left, int top, int right, int bottom)
{
 ...
 */
bool Rect::intersect(int left, int top, int right, int bottom)
{
 ...
 */
bool Rect::setIntersect(Rect *a, Rect *b)
{
 ...
 */
bool Rect::intersects(int left, int top, int right, int bottom)
{
 ...
 */
void Rect::_union(int left, int top, int right, int bottom)
{
 ...
 * @hide
 */
void Rect::scaleRoundIn(float scale)
{
    if (scale != 1.0f)
    {
        left = (int) ceil(left * scale);
        top = (int) ceil(top * scale);
        right = (int) floor(right * scale);
        bottom = (int) floor(bottom * scale);
    }
}
